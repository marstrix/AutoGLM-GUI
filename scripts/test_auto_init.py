...
def test_auto_initialize_parameter():
    ...
    assert default_value is False, f"auto_initialize 默认值应该是 False，实际是 {default_value}"
    ...
    default_value = sig.parameters["auto_initialize"].default
    assert default_value is True, f"use_agent auto_initialize 默认值应该是 True，实际是 {default_value}"
    ...
    # 验证 auto_initialize 参数存在
    assert "auto_initialize" in params, "use_streaming_agent 的 auto_initialize 参数不存在"
    default_value = sig.parameters["auto_initialize"].default
    assert default_value is True, f"use_streaming_agent auto_initialize 默认值应该是 True，实际是 {default_value}"
